...
export const REVIEWS: Review[] = [
  {
    ...
    role: "COO",
    text: "GSD transformed our entire back-office operation. What used to take our team 3 days of manual data entry now happens automatically. The ROI was visible within the first month. Maxine's team does not just implement. They understand the business problem first.",
    rating: 5,
    avatar: "SM",
  },
  {
  ...
  },
  {
    ...
    text: "Maxine's background in enterprise data systems shows in everything GSD delivers. They do not over-engineer. They find the 80/20 solution that gets results fast. Our AI voice agent handles 60% of inbound calls now.",
    rating: 5,
    avatar: "DO",
  },
  {
