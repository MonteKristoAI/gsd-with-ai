...
export default function DesktopStickyCTA() {
  ...
  return (
    <Link
      ...
      className={cn(
        "fixed bottom-6 right-6 z-40 hidden items-center gap-2 rounded-full bg-teal-600 px-5 py-3 font-semibold text-white shadow-[0_10px_30px_rgb(13_148_136/0.45)] transition-all duration-300 hover:bg-teal-500 hover:shadow-[0_14px_36px_rgb(13_148_136/0.55)] lg:inline-flex",
