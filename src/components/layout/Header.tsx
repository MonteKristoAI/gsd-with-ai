...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile slide-down panel. top-20 matches header h-20 so the panel
          starts flush with the header bottom border. Earlier value (top-16)
          caused a 16px overlap that hid part of the first link. */}
      <div
        className={cn(
          "fixed left-0 right-0 top-20 z-[49] lg:hidden",
